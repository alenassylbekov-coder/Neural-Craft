...
const AI_FACTS = [
  ...
  { emoji: '🔊', text: 'ИИ-модель Whisper от OpenAI транскрибирует речь на 99 языках с точностью профессионального стенографиста.' },
  { emoji: '🧊', text: 'Для охлаждения дата-центров с ИИ тратится столько воды, сколько потребляет небольшой город.' },
  { emoji: '🎯', text: 'ИИ в медицине сократил время расшифровки рентгеновских снимков с 20 минут до 3 секунд.' },
  { emoji: '🦾', text: 'Нейроинтерфейс Neuralink от Илона Маска позволил парализованному человеку управлять компьютером силой мысли.' },
  { emoji: '🎪', text: 'ИИ от Sony написал песню «Daddy\'s Car» в стиле The Beatles, которую невозможно отличить от оригинала.' },
  { emoji: '🏛️', text: 'В 2023 году ООН провела первое заседание по регулированию ИИ — 193 страны обсуждали будущее технологии.' },
  { emoji: '🧲', text: 'Квантовые компьютеры Google решают задачи за 200 секунд, на которые обычному ПК нужно 10,000 лет.' },
  { emoji: '🐝', text: 'Нейросети научились предсказывать вымирание пчёл, анализируя звуки ульев с точностью 92%.' },
  { emoji: '🗺️', text: 'ИИ восстановил 80% утраченных фресок Помпей, воссоздав цвета и детали по микрофрагментам.' },
  { emoji: '🔐', text: 'ИИ может взломать простой пароль из 6 символов менее чем за 1 секунду.' },
  { emoji: '🌱', text: 'ИИ в сельском хозяйстве помогает увеличить урожайность на 30%, анализируя состояние почвы со спутников.' },
  { emoji: '🎓', text: 'К 2025 году 85% взаимодействий с клиентами в бизнесе управляются ИИ без участия человека.' },
  { emoji: '🦴', text: 'ИИ обнаружил древний затерянный город майя, анализируя лидарные снимки джунглей.' },
  { emoji: '🎲', text: 'Нейросеть научилась блефовать в покер лучше профессионалов — ИИ Pluribus выиграл $1.8 млн у 6 чемпионов.' },
  { emoji: '🛰️', text: 'ИИ обрабатывает 150 ТБ спутниковых данных в день для мониторинга вырубки лесов в реальном времени.' },
  { emoji: '🎹', text: 'ИИ Suno генерирует полноценные песни с вокалом за 30 секунд — от рэпа до оперы.' },
  { emoji: '🏋️', text: 'ChatGPT набрал 1 миллион пользователей за 5 дней — это абсолютный рекорд среди всех приложений.' },
  { emoji: '🔭', text: 'ИИ помог составить первую в истории фотографию чёрной дыры, обработав 5 петабайтов данных.' },
  { emoji: '🧑‍🎨', text: 'ИИ-арт занял первое место на конкурсе живописи Colorado State Fair, вызвав споры о природе творчества.' },
  { emoji: '📚', text: 'Claude от Anthropic может прочитать и проанализировать книгу в 500 страниц за 20 секунд.' },
  { emoji: '🏠', text: 'ИИ-архитектор спроектировал здание, которое потребляет на 40% меньше энергии, чем аналогичные проекты людей.' },
  { emoji: '🧠', text: 'Человеческий мозг потребляет 20 Ватт, а нейросеть GPT-4 при обучении — около 50 Мегаватт.' },
  { emoji: '🎥', text: 'ИИ Sora от OpenAI генерирует фотореалистичные видео длиной до минуты по текстовому описанию.' },
  { emoji: '🗣️', text: 'ИИ переводит речь в реальном времени с задержкой 0.3 секунды, сохраняя интонацию и тембр говорящего.' },
  { emoji: '🧬', text: 'Google DeepMind создал ИИ-модель, которая предсказывает погоду точнее метеорологов на 10 дней вперёд.' },
  { emoji: '🤝', text: 'К 2030 году ИИ создаст 97 миллионов новых рабочих мест, хотя 85 миллионов могут исчезнуть.' },
  { emoji: '🌈', text: 'ИИ научился раскрашивать чёрно-белые фотографии, воссоздавая оригинальные цвета с точностью 85%.' },
  { emoji: '💬', text: 'GPT-4 способен вести диалог на 26 языках одновременно, переключаясь между ними в одном предложении.' },
  { emoji: '🐕', text: 'ИИ-ошейник переводит лай и движения собак в человеческие эмоции с точностью 80%.' },
  { emoji: '🔋', text: 'ИИ от Microsoft помог обнаружить новый материал для батарей, который заряжается в 5 раз быстрее лития.' }
];

function renderFactOfDay() {
  const el = document.getElementById('fact-of-day');
  if (!el) return;
  // Rotate every 3 hours instead of daily
  const hours3 = Math.floor(Date.now() / (3 * 60 * 60 * 1000));
  const fact = AI_FACTS[hours3 % AI_FACTS.length];
  el.innerHTML = `
